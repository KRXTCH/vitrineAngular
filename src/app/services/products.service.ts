...
export class ProductsService {
  ...
  products: Product[] = [
    new Product(
      ...
      { Limited: 72.99, Collector: 57.99, Standard: 42.99 }
    ),
    new Product(
      2,
      ...
      { Limited: 67.99, Collector: 52.99, Standard: 37.99 }
    ),
    new Product(
      3,
      ...
      { Limited: 54.89, Collector: 39.89, Standard: 24.89 }
    ),
    new Product(
      4,
      'Martha Is Dead',
      ...
      { Limited: 52.49, Collector: 28.49, Standard: 13.49 }
    ),
    new Product(
      5,
      'Ready or Not',
      ...
      { Limited: 59.99, Collector: 45.99, Standard: 30.19 }
    ),
    new Product(
      6,
      'God of War',
      ...
      { Limited: 62.99, Collector: 47.69, Standard: 32.69 }
    ),
    new Product(
      7,
      ...
      { Limited: 56.99, Collector: 39.99, Standard: 26.99 }
    ),
    new Product(
      8,
      ...
      new Date('01/17/2021'),
      'https://s3.gaming-cdn.com/img/products/1919/pcover/1919.jpg',
      { Limited: 44.99, Collector: 28.49, Standard: 14.49 }
    ),
    new Product(
      9,
      'Horizon Zero Dawn',
